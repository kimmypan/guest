...
TEMPLATES_DIR = (os.path.join(BASE_DIR,"guest\\templates"),)
...
SECRET_KEY = 'zq(b1f)a(t2@btgm*t0jg@q4nnmb*165(1i!^=o0dhvj2rx$#4'
...
DATABASES = {
    ...
    'default': {
        ...
        'NAME': 'test',  # Your db name, Or path to database file if using sqlite3

        'USER': 'root',  # Your db user name, Not used with sqlite3

        'PASSWORD': 'kimmy1203',  # Your db password, Not used with sqlite3
